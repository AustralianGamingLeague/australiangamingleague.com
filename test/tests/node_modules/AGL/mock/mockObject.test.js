...
describe('mockObject', function () {
	...
	describe('Mock Object', function () {
		...
		it('should not throw an error when an unmocked function is called while functions are not being enforced', function () {
		...
		it('should allow chaining of unmocked functions while functions are not being enforced', function () {
			var mockTestObject = mockObject.NewMockObject('TestObject', false);
			assert.doesNotThrow(
				function () {
