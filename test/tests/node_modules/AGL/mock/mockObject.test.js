...
describe('mockObject', function () {
	...
	describe('Mock Object', function () {
		...
		it('should throw an error if an unmocked function is called', function () {
			var mockTestObject = mockObject.NewMockObject();
					console.log(mockTestObject.Function7);
			assert.throws(
				function () {
		...
		it('should allow an unmocked function to be called if enforceALlFunctions is false', function () {
		});

		it('should allow chaining of unmocked functions if enforceAllFunctions is false', function () {
		});
