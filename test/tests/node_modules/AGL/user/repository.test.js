...
var dbAccessorMock = require('AGL/mock/database/dbAccessorMock');
...
describe('repository', function () {
	...
	dbAccessorMock.SetCallback(function (callback) {
		return callback(testData.queryError, testData.queryResult);
	});
	var userFactoryMock = {};
	...
	describe('InsertUser()', function () {
		...
		it('should insert a new user into the database if it does not exist', function (done) {
			...
			repository.InsertUser(user, function (error, username) {
				assert.strictEqual(
					username,
					user.GetUsername(),
					'expected to return users username'
				);
				done();
			});
		});

		it.skip('should return an error to the callback when insert fails', function (done) {
		});
