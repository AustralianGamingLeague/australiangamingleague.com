...
// key = code moment.js returns from invalidAt()
var MOMENT_DATE_UNIT_MAP = {
	0 : 'Years',
	1 : 'Months',
	2 : 'Days',
	3 : 'Hours',
...
/*
 *  private object ValidateDatetime(value)
 *
 *  Validate datetime in format 'YYYY-MM-DD HH:mm:ss'
 *
...
function ValidateDatetime(value) {
	...
	var datetime = moment(value, ['YYYY-MM-DD HH:mm:ss'], true);

	if (!datetime.isValid()) {
		var dateUnitOverflow = '';
		if (datetime.invalidAt() !== -1) {
			dateUnitOverflow = MOMENT_DATE_UNIT_MAP[datetime.invalidAt()] + ' unit is invalid.';
		}
		return new TypeError('\'' + value + '\' is not a valid datetime string. '
			+ dateUnitOverflow
