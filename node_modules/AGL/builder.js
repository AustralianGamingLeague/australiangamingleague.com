 ...
 *  the object. If there are any validation errors during execution of the Build
 *  function, an array of Error objects will be thrown. If you wish to handle them
 *  differently, call OnValidationErrors(handler) and the builder will pass the 
 *  errors to the provided handler instead.
 *
 *  var userPropertyMap = {
 *      username : {
 *          required : true,
...
function Builder (propertyMap, objectName) {
    ...
    var properties = {};
    var validationErrorHandler = function (errors) {
        throw errors;
    };
