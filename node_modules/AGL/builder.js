...
var validation = require('AGL/validation'); // Validates properties
var validate   = require('validate.js');    // General validation
...
function ValidateProperties (propertyMap, properties, objectName) {
	...
	for (var property in propertyMap) {
		...
		var validationError = validation.Validate(propertyMap[property].type, properties[property]);
		if (validationError) {
...
function Builder (propertyMap, objectName) {
	...
	for (var property in propertyMap) {
		...
		this[setterName] = function (propertyName, value) {
	...
	this.OnValidationErrors = function (handler) {
		if (!validate.isFunction(handler)) {
			throw new Error('OnValidationErrors(). handler argument must be a function.');
		}
	...
	this.Build = function () {
		...
		var validationErrors = ValidateProperties(propertyMap, properties, objectName);
...
function ImmutableObject (properties) {
	...
	for (var property in properties) {
		...
		this[getterName] = function (propertyName) {
